...
\item[Copying a record type] This facilitated the creation of new record types based on an existing one, without altering the original.
...
(The answer could alternatively be considered correct, as all persons seen are actually to the left of the car, from the perspective of the car itself. This would however be a pointless coincidence, as there is no support in this model for intrinsic spatial relations, as discussed in \autoref{sec:method-spatrel}.)
