...
\autoref{item:relclfsbel} works here because $ag.\text{state.bel}$ is sure to contain only $IndObj$ record types at this point, and because $ag.\text{relclfs}$ only contains $RelClf$ functions.
...
\begin{listing}
\begin{lstlisting}[label={lst:find_subtype_relabeling}]
