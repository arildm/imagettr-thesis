...
\usepackage{lscape}
\lstset{language=Python,basicstyle=\footnotesize,breaklines=true,breakatwhitespace=true}
...
Thanks to my supervisor Simon Dobnik and also to Staffan Larsson, who in practice also functioned as a supervisor.
