...
Results with confidence over a certain threshold are cast into \gls{ttr} records as described in \autoref{sec:python}.
...
The existing research on \gls{ttr}-based approaches to textual or phonetic parsing, overviewed in \autoref{sec:ttnlp}, would surely cover the kind of utterances considered here.
