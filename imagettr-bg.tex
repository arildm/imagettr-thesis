...
Relationships between objects can be modeled using \textbf{ptypes}.
...
The type $Type^n, n > 0$ is the type of all types of order $n - 1$.
Similarly, $RecType^n, n > 0$ is the type of all record types of order $n - 1$.
Most of the types in this thesis will be of order $0$, so we will skip the order superscript unless necessary, and use $Type$ and $RecType$ to denote $Type^1$ and $RecType^1$, respectively.
